    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <h2>Add to Settings</h2>
          ...
          <form class="form-horizontal" action="setting-post.php" method="POST" enctype="multipart/form-data">
          <div class="row">
          <div class="form-group col-md-6">
            <label class="control-label col-sm-2">Tagline:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" placeholder="Enter Your Tagline" name="tagline">
            </div>
          </div>
          <div class="form-group col-md-6">
            ...
            <textarea type="text" class="form-control" value="$about"  placeholder="Enter Your About" name="about" rows="5"></textarea>
            </div>
          </div>
          <div class="form-group col-md-6">
            ...
            <div class="col-sm-10">
              ...
              id="logo" name="logo" onchange="document.getElementById('logo_white').src= window.URL.createObjectURL(this.files[0])">
            </div>
          </div>
          <div class="form-group col-md-6">
            <label class="control-label col-sm-2">White logo Preview::</label>
            <div class="col-sm-10">
              <img id="logo_white" src="../assets/img/<?= $result['logo']?>" width="100" height="100">
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" placeholder="Enter Your Copyright" name="copyright">
            </div>
          </div>
          <div class="form-group col-md-6">
            <label class="control-label col-sm-2">Office Address:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" placeholder="Enter Your Office Address" name="office_address">
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            <label class="control-label col-sm-2">Black Logo Preview::</label>
            <div class="col-sm-10">
